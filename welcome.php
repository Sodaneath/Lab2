...
<head>
    ...
    <link rel="apple-touch-icon" href="./assets/logo/favicon/apple-icon-57x57.png" />
...
<body>
    ...
    <div class="main-wrapper">
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="menu_area alt-font">
                                <nav class="navbar navbar-expand-lg navbar-light p-0">
                                    <div class="navbar-header navbarheader-custom">
                                    <!-- start logo -->
                                    <a href="#" class="navbar-brand inner-logo"><img id="logo" src="./assets/logo/FE_logo.jpeg" alt="logo">
                                    </a>
                                    <!-- end logo -->
                                    </div>
                                </nav>
        ...
        <section>
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-5 mb-lg-0 hover-style3 textcenter text-lg-start">
                    ...
                    <div class="col-lg-6">
                        <div class="ps-lg-5">
                            ...
                            <p class="display-28 mb-1-8">Bachelor of
                                ...
                                Engineering, Royal University of Phnom Penh is designed to provide highquality
                                training in Information Technology which meets the current and
        ...
        <footer class="pt-6 pt-sm-8 pt-lg-10">
            <div class="container">
                <div class="row pb-6 pb-sm-8 pb-lg-10">
                    ...
                    <ul class="list-unstyled social-icon01 p-0 m-0">
                        ...
                        <li><a href="#!"><i class="fab fa-linkedinin"></i>
                        </a></li>
                    </ul>
                </div>
                    <div class="col-sm-6 col-lg-2 mb-4 mb-sm-5 mb-lg-0">
                        <h3 class="h5 font-weight-500 mb-3 mb-lg-4 textwhite normal">Services</h3>
                        <ul class="footer-list02">
                            <li><a href="#!" class="text-white-60 hover white">Web Design</a></li>
                            <li><a href="#!" class="text-white-60 hoverwhite">Development</a></li>
                            <li><a href="#!" class="text-white-60 hoverwhite">WordPress</a></li>
                            <li><a href="#!" class="text-white-60 hoverwhite">Online Marketing</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-6 col-lg-3 mb-4 mb-sm-0">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <h3 class="h5 font-weight-500 mb-3 mb-lg-4 textwhite normal">Newsletter</h3>
                            <div class="mb-0">
                                <!-- start form here -->
                                <form class="quform" action="quform/newsletter-two.php" method="post" enctype="multipart/formdata"
                                    onclick="">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="quform-element form-group">
                                                    <div class="quform-input">
                                                        <input class="formcontrol" id="email_address" type="text" name="email_address" placeholder="Subscribe with us" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="quform-submitinner">
                                                    <button class="btn btnprimary w-100 py-2" type="submit"><span>Subscribe</span></button>
                                                </div>
                                                <div class="quform-loadingwrap text-center"><span class="quform-loading"></span></div>
                                            </div>
                                            <!-- End Submit button -->
                                        </div>
                                    </div>
            ...
            <div class="text-center border-top py-4 border-color-lightwhite">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <p class="text-white-90 mb-0">&copy; Copyright IT Engineering <span class="current-year"></span>. All Rights Reserved.
                            </p>
                        </div>
                    </div>
                </div>
